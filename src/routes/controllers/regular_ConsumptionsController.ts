...
import { regular_ConsumptionsService } from "../../services/regular_ConsumptionsService";

export class regular_ConsumptionsController {
    
        private router: Router = Router();
        private regular_ConsumptionsService = new regular_ConsumptionsService();
