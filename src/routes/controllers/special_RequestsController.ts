...
import { special_RequestsService } from "../../services/special_RequestsService";

export class special_RequestsController {
    
        private router: Router = Router();
        private special_RequestsService = new special_RequestsService();
