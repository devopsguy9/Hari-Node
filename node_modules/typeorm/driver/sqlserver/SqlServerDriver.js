...
var SqlServerDriver = (function () {
    ...
    SqlServerDriver.prototype.connect = function () {
        ...
        return new Promise(function (ok, fail) {
            var connection = new _this.mssql.ConnectionPool(options).connect(function (err) {
                if (err)
                    return fail(err);
                _this.connectionPool = connection;
                ok();
            });
        });
    };
    ...
    SqlServerDriver.prototype.createQueryRunner = function () {
        return new SqlServerQueryRunner_1.SqlServerQueryRunner(this);
    };
    /**
    ...
    SqlServerDriver.prototype.parametrizeValue = function (column, value) {
        ...
        return new MssqlParameter_1.MssqlParameter(value, column.type);
    };
    /**
     * Sql server's parameters needs to be wrapped into special object with type information about this value.
